...
ARG MONGODB_URI
ARG MONGODB_MAX_POOL_SIZE
ARG MONGODB_MIN_POOL_SIZE
ARG MONGODB_SOCKET_TIMEOUT_MS
ARG MONGODB_CONNECT_TIMEOUT_MS
ARG MONGODB_KEEP_ALIVE
...
ENV VITE_AZURE_CLIENT_ID=${VITE_AZURE_CLIENT_ID} \
    ...
    MONGODB_KEEP_ALIVE=${MONGODB_KEEP_ALIVE}
